...
class TestElement:
    def __init__(self, parent_frame, row, test_name, r_range):
    ...
    def create_widgets(self):
        ...
        ttk.Label(self.parent_frame, text="Unit", font=("Helvetica", 12, "bold")).grid(row=self.row, column=10, padx=20, pady=5)
